...
Hatena_ReferenceNode.prototype = Object.extend(new Hatena_Node(), {
	...
	parse : function(){
		...
		for(var i = 0; i < c.self.references.length; i++) {
			...
			num++;
			text.parse(note);
			var l = t + '\t<li class="reference"><a href="' + p + '#ref' + num + '" name="r' + num + '">[' + num + ']</a> '
				+ text.html() + '</li>';
			this.self["html"] += l + "\n";
		}
...
Hatena_SectionNode.prototype = Object.extend(new Hatena_Node(), {
	init : function(){
		this.self.childnode = ["nume", "tcap","fcap","ref","h6","h5", "h4", "h3", "blockquote", "dl", "list", "block", "pre", "superpre", "table", "tagline", "tag"];
...
Hatena_BlockquoteNode.prototype = Object.extend(new Hatena_SectionNode(), {
	init : function(){
		this.self.pattern = /^>¥$/;
		this.self.endpattern = /^¥<$/;
		this.self.childnode = ["h4", "h5","h6","ref","fcap","tcap","nume",  "blockquote", "dl", "list", "block", "pre", "superpre", "table"];//, "tagline", "tag"];
		this.self.startstring = "<blockquote>";
		this.self.endstring = "</blockquote>";
	},
...
Hatena_TagNode.prototype = Object.extend(new Hatena_SectionNode(), {
	init : function(){
		this.self.pattern = /^>(<.*)$/;
		this.self.endpattern = /^(.*>)<$/;
		this.self.childnode = ["h4", "h5","h6","ref","fcap","tcap", "nume", "blockquote", "dl", "list","block", "pre", "superpre", "table"];
		this.self.child_node_refs = Array();
	},
