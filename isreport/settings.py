...
EXPORT_PATH = "isbookshelf/download/"
...
if DEPLOY:
    ...
    DATABASES = {
        'default': {
            ...
            'NAME': 'isreport',                      # Or path to database file if using sqlite3.
...
# if DEPLOY:
#     MEDIA_ROOT = 'http://is.doshisha.ac.jp/isapps/static/'
# else:
...
TEMPLATE_DIRS = (
    ...
    os.path.join(BASE_DIR, '../isbookshelf/templates'),
